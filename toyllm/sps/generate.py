        ...
        while n < target_seq_len:
            with torch.inference_mode():
                ...
                for _ in range(self.lookahead):
                    draft_model_probs = self.draft_model.forward(draft_prompt_tokens, config.temperature)
                ...
                target_model_probs = self.target_model.forward(draft_prompt_tokens, config.temperature)
